  ...
  (0, _createClass2.default)(Tabs, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (this.state.indicatorStyle !== prevState.indicatorStyle) {
        ...
        // The effect of this function in our toolbar was to cause 'rubber-banding' when either:
        //
        //  1. In a toolbar with multiple 'sections' (groups of tabs), having the last tab selected
        //     and then using the arrow buttons to try navigating to the first tab would result in the
        //     toolbar bouncing back to the last tab, or
        //  2. The above situation, but with first and last swapped.
